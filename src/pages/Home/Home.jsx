  ...
  return (
    <div className='md:pt-[17%] md:p-2   dark:bg-[#000] dark:text-white flex flex-wrap  '>
      <div className='w-[60%] md:p-0  md:w-full'>
        <div className='w-full  pt-10 pl-2 flex overflow-x-scroll  stories'>
          <div className='pl-2'>
        ...
        <div className='w-[70%] mx-auto pt-[30px]'>
          <div>
             ...
             <svg aria-label="Поделиться публикацией" className="x1lliihq x1n2onr6 hidden dark:block" color="rgb(245, 245, 245)" fill="rgb(245, 245, 245)" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Поделиться публикацией</title><line fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2" x1="22" x2="9.218" y1="3" y2="10.083"></line><polygon fill="none" points="11.698 20.334 22 3.001 2 3.001 9.218 10.084 11.698 20.334" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></polygon></svg>
              ...
              <svg aria-label="Сохранить" className="x1lliihq x1n2onr6 hidden dark:block" color="rgb(245, 245, 245)" fill="rgb(245, 245, 245)" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Сохранить</title><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polygon></svg>
              </div>


             </div>
             <div className='pt-2'>
              <input type="text" placeholder='Добавьте коментарий...' className='w-full border-0 p-2 dark:bg-[#000] rounded-lg' />
             </div>
             <hr />
          </div>
...
<svg aria-label="Поделиться публикацией" className="x1lliihq x1n2onr6 hidden dark:block" color="rgb(245, 245, 245)" fill="rgb(245, 245, 245)" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Поделиться публикацией</title><line fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2" x1="22" x2="9.218" y1="3" y2="10.083"></line><polygon fill="none" points="11.698 20.334 22 3.001 2 3.001 9.218 10.084 11.698 20.334" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></polygon></svg>
 ...
 <div>
 <svg aria-label="Сохранить" className="x1lliihq x1n2onr6 dark:hidden" color="black" fill="black" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Сохранить</title><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polygon></svg>
 <svg aria-label="Сохранить" className="x1lliihq x1n2onr6 hidden dark:block" color="rgb(245, 245, 245)" fill="rgb(0, 0, 0)" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Сохранить</title><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polygon></svg>
 </div>
