  ...
  return (
    <div className="md:pt-[17%] md:p-2   dark:bg-[#000] dark:text-white flex flex-wrap  ">
      <div className="w-[60%] md:p-0  md:w-full">
        <div className="w-full  pt-10 pl-2 flex overflow-x-scroll gap-x-[12px] stories">
          <div className="pl-2">
          ...
          <div>
            ...
            <div className="pt-2 flex justify-between">
              <div className="flex gap-x-3">
                <svg
                  ...
                  className="x1lliihq x1n2onr6 dark:hidden"
                  color="black"
                  fill="black"
                  height="24"
                  role="img"
            ...
            <div className="pt-2">
              <input
                ...
                className="w-full border-0 p-2 dark:bg-[#000] rounded-lg"
              />
            </div>
            <hr />
          </div>
      ...
      <div className="w-[35%] h-[80vh] md:hidden flex flex-col justify-center pt-[40px]  px-2 ">
        ...
        <div className="pt-5 flex gap-x-3">
          ...
          <div className="flex flex-col">
            <span className="font-[600]">milord__007</span>
            <p className="text-[grey]">Подписан(-а) eur1725</p>
          </div>
        </div>
        ...
        <div className="pt-5 flex gap-x-3">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-[grey]">
              Подписан(-а) eur1725{" "}
              <span className="pl-[20px] text-[#0066ff]">Подписаться</span>
            </p>
          </div>
        </div>
