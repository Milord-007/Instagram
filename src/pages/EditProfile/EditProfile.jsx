        ...
        <div className="flex w-[80%] border-2 mt-[50px] mx-auto md:flex-col">
          ...
          <div className="w-[70%] pt-[10px] md:w-full">
            ...
            <div className="flex w-[80%] mx-auto gap-x-[30px] pt-[30px]">
              ...
              <div>
                <p>milord__007</p>
                <button className="text-[#4f52f7] text-[14px]">
            ...
            <div className="flex w-[80%] mx-auto gap-x-[30px] pt-[30px]">
              ...
              <div className="flex flex-col">
                <input
                  type="text"
                  className="rounded-lg p-1 border-none dark:bg-[#262626]"
                  placeholder="Сайт"
                />
                <p className="text-[14px] mt-2">
                  Изменить ссылки можно только в мобильной версии. Перейдите в
                  приложение Instagram и коснитесь "Редактировать профиль".
                </p>
              </div>
            </div>
            <div className="flex w-[80%] mx-auto gap-x-[30px] pt-[30px]">
              ...
              <div className="flex flex-col">
                <textarea
                  type="text"
                  className="rounded-lg p-2 border-none dark:bg-[#262626]"
                  placeholder=""
                />
                <p className="text-[14px] mt-2">
                  Изменить ссылки можно только в мобильной версии. Перейдите в
            ...
            <div className="flex w-[80%] mx-auto gap-x-[30px] pt-[30px]">
              ...
              <div className="flex flex-col">
                <input
                  type="text"
                  className="rounded-lg p-1 border-none dark:bg-[#262626]"
                  placeholder="Предпочитаю не указывать"
                />
