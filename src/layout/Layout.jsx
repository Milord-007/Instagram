          ...
          <div className="hidden md:flex items-center  w-full px-3">
            <div className="flex">
              <Link>
                ...
                <svg
                  aria-label="Instagram"
                  className="_ab6- hidden dark:block"
              ...
              >
                <MenuItem
                  onClick={handleClose}
                  className="dark:bg-[#232323] dark:hover:bg-[#000] dark:text-white"
                >
                  Подписки
                </MenuItem>
                <MenuItem
            ...
            <div className="w-[50%]">
              <div className="sm:hidden  md:flex items-center relative ">
                ...
                <input
                  className="border-2 dark:border-[black] w-full py-[5px] pl-[40px] rounded-[5px] dark:text-[grey]  bg-[#EFEFEF] dark:bg-[#262626]"
                  placeholder="Поиск"
                  type="search"
                />
              </div>
            ...
            <ul className="mt-[30px]">
              <Link>
                <li className="flex gap-x-[20px] cursor-pointer">
                  ...
                  <p className="pt-1 font-[600] text-[16px]  dark:text-white">
                    Главная
                  </p>
                </li>
              </Link>
              <Link>
                <li className="flex gap-x-[20px] cursor-pointer mt-7">
                  ...
                  <p className="pt-1 font-[600]  dark:text-white">
                    Поисковый запрос
                  </p>
                </li>
              </Link>
          ...
          >
            ...
            <Link to={"editPassword"}>
              ...
              >
                <svg
                  ...
                  className="x1lliihq x1n2onr6 mr-3 dark:hidden"
                  color="black"
                  fill="black"
                  height="24"
                  role="img"
                ...
                <svg
                  aria-label="Параметры"
                  className="x1lliihq x1n2onr6 hidden dark:block mr-3"
                  color="rgb(245, 245, 245)"
                  fill="rgb(0, 0, 0)"
                  height="24"
                  role="img"
            ...
            >
              <svg
                ...
                className="x1lliihq x1n2onr6 dark:hidden  mr-3"
                color="black"
                fill="black"
                height="18"
                role="img"
            ...
            >
              {" "}
              <i className="fa-regular fa-bookmark text-[20px] mr-3"></i>{" "}
              Сохраненное
            </MenuItem>
            <MenuItem
              aria-controls={open2 ? "basic-menu" : undefined}
              ...
              <div>
                ...
                <div className="w-full flex justify-evenly pt-8">
                  <button
                    ...
                    className="p-2 bg-[#000] w-[90px] text-white hover:bg-darkred"
                  >
                    Нет
                  </button>
                  <Link
                  ...
                  >
                    <button className="p-2 bg-[#000] w-[90px] text-white hover:bg-darkblue">
                      Да
                    </button>
                  </Link>
                </div>
